...
ASSISTANT_VER="d2eb8e1e40c5a78909f698a2d12c4f146c2976ba"
...
DOCTEST_VER="1da23a3e8119ec5cce4f9388e91b065e20bf06f5"
...
SRC_URI="
	...
	https://github.com/doctest/doctest/archive/${DOCTEST_VER}.tar.gz -> doctest-${DOCTEST_VER}.tar.gz
...
PATCHES=(
	"${FILESDIR}/${PN}-18.3_don-t-strip-during-install.patch"
	"${FILESDIR}/${PN}-18.3-disable-automatic-ccache-configuration.patch"
	"${FILESDIR}/${PN}-18.3-enable-switch-to-use-system-yaml-cpp.patch"
...
src_unpack() {
	...
	mv -f doctest-"${DOCTEST_VER}" doctest
	...
	mv -f -t "${S}"/submodules/ assistant cc-wrapper cJSON ctags doctest dtl hunspell lexilla libssh lua LuaBridge openssl-cmake wxdap yaml-cpp zlib
