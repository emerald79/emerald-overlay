...
# $Header: /var/cvsroot/gentoo-x86/media-video/vlc/vlc-1.1.7.ebuild,v 1.3 2011/02/01 20:19:32 xarthisius Exp $
...
src_prepare() {
	...
	epatch "${FILESDIR}/vlc-1.1.7-libmatroska-1.1.0.patch"
	eautoreconf
}
